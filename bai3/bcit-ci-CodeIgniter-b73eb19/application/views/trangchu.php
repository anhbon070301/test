        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="/hochtml/bai3/bcit-ci-CodeIgniter-b73eb19/hinh/LOGO/HONDA.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="/hochtml/bai3/bcit-ci-CodeIgniter-b73eb19/hinh/LOGO/YAMAHA.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="/hochtml/bai3/bcit-ci-CodeIgniter-b73eb19/hinh/LOGO/SUZUKI.jpg" alt="Third slide">
            </div>
          </div>
